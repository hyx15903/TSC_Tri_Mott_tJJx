...
plot "Fig2a.dat" index 0 using ($1/pi/2.):3 w lp title "$J_{2}=0.05, J_{\\chi }=0.05$" ls 4,\
"Fig2a.dat" index 1 using ($1/pi/2.):3 w lp title "$J_{2}=0.1, J_{\\chi }=0.05$" ls 2,\
"Fig2a.dat" index 2 using ($1/pi/2.):3 w lp title "$J_{2}=0.1, J_{\\chi }=0.1$" ls 1
...
plot "Fig2a.dat" index 3 using ($1/pi/2.):3 w lp title "$J_{2}=0.01, J_{\\chi }=0.05$" ls 3,\
"Fig2a.dat" index 4 using ($1/pi/2.):3 w lp title "$J_{2}=0.2, J_{\\chi }=0.2$" ls 5
...
plot "Fig2b.dat" index 0 using ($1/pi/2.):3 w lp title "$L_{y}=4$" ls 1,\
"Fig2b.dat" index 1 using ($1/pi/2.):3 w lp title "$L_{y}=5$" ls 2,\
"Fig2b.dat" index 2 using ($1/pi/2.):3 w lp title "$L_{y}=6$" ls 4
...
plot "Fig2c.dat" index 0 using 1:2 w lp title "$J_{\\chi }=0.05$" pt 7 lc rgb "grey10" lw 3 ps s
...
plot "Fig2d.dat" index 0 using 1:4 w lp title "$J_{2}=0.1, J_{\\chi }=0.1$" ls 1,\
"Fig2d.dat" index 0 using 1:3 w lp title "$J_{2}=0.05, J_{\\chi }=0.05$" ls 4,\
"Fig2d.dat" index 0 using 1:2 w lp title "$J_{2}=0.04, J_{\\chi }=0.05$" ls 6
