...
set output "Nature_Phase_tranistion.tex"
...
plot "ES_N16x6.dat" u 1:($2/96) w lp notitle ls 1 axis x1y1,\
"ES_N16x6.dat" u 1:3 w lp notitle ls 3 axis x1y2
...
plot "ES_N16x6.dat" u (dx=$1-x0,x0=$1,$1-dx/2):(dy=($2/96)-y0,y0=($2/96),-dy/dx) w lp notitle ls 1 axis x1y1

#"ES_N16x6.dat" u (dx2=$1-x20,x20=$1,$1-dx2/2):(dy2=($3)-y20,y20=($3),-dy2/dx2) w lp #notitle ls 3 axis x1y2
...
#set arrow 2 from 0.1,-2000 to 0.1,-300 as 4 lc rgb "red"
#set label "$J_{2c}^{(3)}$" at 0.101,-1800 textcolor rgb "red"
...
plot "ES_N16x6.dat" u (dx=$1-x1,dx1=x1-x0,x0=x1,x1=$1,$1-dx/2-(dx+dx1)/4):(dy=($2/96-y1)/dx-(y1-y0)/dx1,y0=y1,y1=$2/96,dy/((dx+dx1)/2)) w lp notitle ls 1
...
plot "ES_N16x6.dat" u (dx2=$1-x20,x20=$1,$1-dx2/2):(dy2=($3)-y20,y20=($3),-dy2/dx2) w lp notitle ls 3
...
plot "ES_N16x6.dat" u (dx2=$1-x21,dx21=x21-x20,x20=x21,x21=$1,$1-dx2/2-(dx2+dx21)/4):(dy2=($3-y21)/dx2-(y21-y20)/dx21,y20=y21,y21=$3,dy2/((dx2+dx21)/2)) w lp notitle ls 3

#"ES_2st.dat" u 1:2 w lp notitle ls 3 axis x1y1,\
#"ES_2st.dat" u 1:3 w lp notitle ls 4 axis x1y2
