...
set output "Phase_transition_v4.tex"
#Fig4
...
plot "jx0.05j20.05/Sc_cor_ph.dat" index 0 using 4:($8-$9) w lp title "$\\theta _{ba }$" ls 1,\
"jx0.05j20.05/Sc_cor_ph.dat" index 0 using 4:($8-$10) w lp title "$\\theta _{bc }$" ls 4
...
plot "jx0.05j20.1/Sc_cor_ph.dat" index 0 using 4:($8-$9) w lp title "$\\theta _{ba }$" ls 2,\
"jx0.05j20.1/Sc_cor_ph.dat" index 0 using 4:($8-$10) w lp title "$\\theta _{bc }$" ls 5

unset label
set key at 25,4.4
set label "$J_{2}=0.15$" at 5,4.0
plot "jx0.05j20.15/Sc_cor_ph.dat" index 0 using 4:($8-$9) w lp title "$\\theta _{ba }$" ls 3,\
"jx0.05j20.15/Sc_cor_ph.dat" index 0 using 4:($8-$10) w lp title "$\\theta _{bc }$" ls 6
...
set key at 25,6.0
set label "$J_{2}=0.05$" at 5,5.6
plot "jx0.05j20.05Ny4/Sc_cor_ph.dat" index 0 using 4:($8-$9) w lp title "$\\theta _{ba }$" ls 1,\
"jx0.05j20.05Ny4/Sc_cor_ph.dat" index 0 using 4:($8-$10) w lp title "$\\theta _{bc }$" ls 4
...
set key at 25,5.2
set label "$J_{2}=0.1$" at 5,4.8
plot "jx0.05j20.1Ny4/Sc_cor_ph.dat" index 0 using 4:($8-$9) w lp title "$\\theta _{ba }$" ls 2,\
"jx0.05j20.1Ny4/Sc_cor_ph.dat" index 0 using 4:($8-$10) w lp title "$\\theta _{bc }$" ls 5

unset label
set key at 25,4.4
set label "$J_{2}=0.15$" at 5,4.0
plot "jx0.05j20.15Ny4/Sc_cor_ph.dat" index 0 using 4:($8-$9) w lp title "$\\theta _{ba }$" ls 3,\
"jx0.05j20.15Ny4/Sc_cor_ph.dat" index 0 using 4:($8-$10) w lp title "$\\theta _{bc }$" ls 6

unset label
set key at 25,1.4
set label "$J_{2}=0.01$" at 5,1
plot "jx0.05j20.01Ny4/Sc_cor_ph.dat" index 0 using 4:($8-$9) w lp title "$\\theta _{ba }$" ls 7,\
"jx0.05j20.01Ny4/Sc_cor_ph.dat" index 0 using 4:($8-$10) w lp title "$\\theta _{bc }$" ls 8
...
plot "jx0.05j20.05/Sc_cor_ph.dat" index 0 using 4:($6/$5) every ::1 w lp title "$|P_{ba}/P_{bb}|$" ls 1,\
"jx0.05j20.05/Sc_cor_ph.dat" index 0 using 4:($7/$5) every ::1 w lp title "$|P_{bc}/P_{bb}|$" ls 2
...
plot "jx0.05j20.1/Sc_cor_ph.dat" index 0 using 4:($6/$5) every ::1 w lp title "$|P_{ba}/P_{bb}|$" ls 11,\
"jx0.05j20.1/Sc_cor_ph.dat" index 0 using 4:($7/$5) every ::1 w lp title "$|P_{bc}/P_{bb}|$" ls 12
...
plot "SC_corr_ave_jx_0.05_different_j2.dat" index 0 using 1:2 w lp title "$|\\overline{\\frac{P_{ba}}{P_{bb}}}|$" ls 3 axis x1y1,\
"SC_corr_ave_jx_0.05_different_j2.dat" index 0 using 1:3 w lp title "$|\\overline{\\frac{P_{bc}}{P_{bb}}}|$" ls 4 axis x1y1
...
plot "SC_corr_ave_jx_0.05_different_j2.dat" index 0 using 1:(-$4) w lp title "$\\overline{\\theta _{ba}}$" ls 1 axis x1y2,\
"SC_corr_ave_jx_0.05_different_j2.dat" index 0 using 1:5 w lp title "$-\\overline{\\theta _{bc}}$" ls 2 axis x1y2
